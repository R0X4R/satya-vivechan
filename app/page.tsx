        ...
        <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col bg-lime-50 px-4 py-10 md:px-0 md:py-12">
            <header className="mb-14 flex flex-col items-center justify-center text-center">
                <Image
                    ...
                    alt="logo images"
                />
                <h1 className="text-6xl md:text-8xl font-black tracking-tighter text-lime-950 uppercase">
                    Satya Vivechan
                </h1>
                <DailyVedicQuote />
            </header>
            <div className="flex w-full flex-col gap-6 md:flex-row">
                ...
                <aside className="w-full space-y-6 border-lime-950/20 py-5 md:py-0 max-md:border-t md:w-1/3 md:border-l-2 md:pl-6">
                    {[
                        {
                        ...
                        <div
                            ...
                            <div className="group relative flex h-32 w-2/5 cursor-pointer items-center justify-center overflow-hidden rounded-lg">
