    ...
    return (
        <div className="group flex w-full items-center gap-4 overflow-hidden">
            ...
            <Link href={link} className="w-3/5">
                <h3 className="dark:text-lime-300 line-clamp-2 font-semibold text-lime-950 selection:bg-lime-950 selection:text-lime-50 md:line-clamp-3">
                    {title}
                </h3>
                <p className="line-clamp-2 dark:text-lime-100/80 text-sm text-lime-950/80 selection:bg-lime-950/80 selection:text-lime-50">
                    {description}
                </p>
                <p className="text-sm dark:text-lime-100/60 text-lime-950/80 selection:bg-lime-950/80 selection:text-lime-50">
                    {author} - {date}
                </p>
            </Link>
        </div>
