        ...
        <Link className="w-full md:col-span-2" href={link}>
            <div className="group w-full">
                ...
                <div className="flex flex-col">
                    <h2 className="mt-4 text-2xl font-bold selection:bg-lime-900 selection:text-lime-50">{title}</h2>
                    <p className="mt-2 line-clamp-2 text-lime-950/80 selection:bg-lime-900/80 selection:text-lime-50">
                        {description}
                    </p>
                    <p className="mt-2 text-sm text-lime-950/80 selection:bg-lime-900/80 selection:text-lime-50">
                        {author} - {date}
                    </p>
                </div>
            </div>
