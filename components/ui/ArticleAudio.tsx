...
export default function ArticleAudio({ audio }: { audio: string }) {
    ...
    return (
        <button
            ...
            className="dark:max-md:text-background flex cursor-pointer items-center justify-center gap-2 text-base font-medium text-lime-900 capitalize transition outline-none selection:bg-lime-900 selection:text-lime-50 max-md:w-full max-md:bg-lime-950 max-md:py-4 max-md:text-lime-50 dark:text-neutral-200/80 dark:max-md:bg-white"
        >
