...
const Header = () => {
    return (
        <header className="fixed top-0 left-0 z-50 w-full px-4 py-3 transition-all duration-300 select-none md:px-0">
            <div className="mx-auto flex max-w-5xl items-center justify-between rounded-xl bg-lime-100 px-4 py-1 ring-1 ring-lime-300/50 md:px-6 md:py-4">
                <Link
                    href="/"
                ...
                <div className="flex gap-3 items-center justify-center">
                    ...
                    <Link
                        href="/"
                        className="hidden group items-center gap-0.5 text-sm font-medium text-lime-900 transition-all duration-300 hover:text-lime-700 md:flex md:text-base">
                        <RxChevronLeft className="size-5 transition-transform duration-300 group-hover:-translate-x-0.5" />
                        Back to Homepage
                    </Link>
